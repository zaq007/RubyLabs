...
class AirportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create airport" do
    assert_difference('Airport.count') do
      post airports_url, params: { airport: { name: @airport.name, place_count: @airport.place_count, town_id: @airport.town_id } }
    end
  ...
  test "should update airport" do
    patch airport_url(@airport), params: { airport: { name: @airport.name, place_count: @airport.place_count, town_id: @airport.town_id } }
