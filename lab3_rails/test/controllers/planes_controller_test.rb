...
class PlanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plane" do
    assert_difference('Plane.count') do
      post planes_url, params: { plane: { name: @plane.name, place_count: @plane.place_count } }
    end
  ...
  test "should update plane" do
    patch plane_url(@plane), params: { plane: { name: @plane.name, place_count: @plane.place_count } }
